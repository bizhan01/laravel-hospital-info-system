...
<div class="content-area py-1">
	<div class="container-fluid">
        ...
        <form method="POST" action="{{route('saveAdvertisement')}}" enctype="multipart/form-data" >
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="from-group">
                            ...
                            <span class="text-danger"> * </span>
                            <textarea name="content" cols="30" rows="10" class="form-control" placeholder="@lang('main.advertis_content_hint')"></textarea>
                            <span class="font-90 text-muted">&nbsp;</span>
                        </div>
                    </div>
                    <div class="col-md-6">
