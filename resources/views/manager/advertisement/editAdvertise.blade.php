                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{$advertise->title}}" class="form-control" maxlength="100" id="placement">
                            ...
                            <div class="from-group">
                                ...
                                <span class="text-danger"> * </span>
                                <textarea name="content" cols="30" rows="10" class="form-control" placeholder="@lang('main.advertis_content_hint')">{{$advertise->content}}</textarea>
                                <span class="font-90 text-muted">&nbsp;</span>
                            </div>
                        </div>
												<div class="col-md-6">
								...
								<input type="hidden" name="status" value="{{$advertise->status}}">
                <!-- buttons -->
                <div class="box box-block bg-white">
