            ...
            <input type="hidden" name="id" value="{{$service->id}}">
                <div class="box box-block bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{$service->name}}" placeholder="@lang('main.service_name_hint')" required>
                            <label for="service_desc">@lang('main.service_desc')</label>
                            <textarea name="service_desc" id="" cols="30" rows="10" class="form-control" placeholder="@lang('main.service_desc_hint')">{{$service->desc}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label>@lang('main.photo')</label>
														<input type="hidden" name="lastPhoto" value="{{$service->photo}}">
                            <input type="file" name="photo" id="input-file-now-custom-1" class="dropify" data-default-file="/img/service/{{$service->photo}}" accept="image/*"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-block bg-white">
                    <center class="row" style="margin-top: 10px">
                        ...
                        <a href="{{route('viewServices')}}" class="btn btn-info label-left mb-0-25 waves-effect waves-light">
