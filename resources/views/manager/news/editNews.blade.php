                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="author_full_name" class="form-control" value="{{$news->author_full_name}}">
                                <span class="font-90 text-muted">&nbsp;</span>
                            </div>
                            <div class="form-group">
                                <label for="title">@lang('main.news_title')</label>
                                <span class="text-danger"> * </span>
                                <input type="text" name="title" class="form-control" maxlength="190" id="placement" value="{{$news->title}}">
                                <span class="font-90 text-muted">&nbsp;</span>
                            </div>
                            ...
                            <div class="from-group">
                                ...
                                <span class="text-danger"> * </span>
                                <textarea name="content" cols="30" rows="10" class="form-control" placeholder="@lang('main.news_content_hint')">{{$news->content}}</textarea>
                                <span class="font-90 text-muted">&nbsp;</span>
                            </div>
                        </div>
												<div class="col-md-6">
														...
														<input type="file" name="photo" id="input-file-now-custom-1" class="dropify" data-default-file="/img/news/{{$news->image}}" accept="image/*"/>
												</div>
                    </div>
                </div>
